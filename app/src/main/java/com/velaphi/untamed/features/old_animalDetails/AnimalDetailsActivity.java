...
public class AnimalDetailsActivity extends AppCompatActivity {
    ...
    private void setAnimalDetails() {
        ...
        TextView descriptionHeaderTextview = findViewById(R.id.description_title_textView);
        TextView descriptionDetailsTextview = findViewById(R.id.description_content_textView);
